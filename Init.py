...
if not has_run_before:
    ...
    # Whether the user wants to use CQ 2.x or 1.x
    FreeCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/cadquery-freecad-module").SetInt("cqMajorVersion", 2)
...
# We only set add these paths to the system path if CadQuery 1.x is being used
